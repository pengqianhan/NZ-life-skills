...
3. For any current eligibility, price, or service-availability question, verify official sources first.
4. Distinguish system navigation from medical advice.

## Source Order

1. Official health system guidance
2. Official provider or student health pages
3. Official pharmacy or clinic pages for location-specific service questions
